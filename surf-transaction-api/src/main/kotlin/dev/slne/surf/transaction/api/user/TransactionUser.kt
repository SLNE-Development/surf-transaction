...
interface TransactionUser {
     ...
     * @return The result of the transaction
     */
    suspend fun deposit(amount: Double, currency: Currency) =
        deposit(BigDecimal.valueOf(amount), currency)
     ...
     * @return The result of the transaction
     */
    suspend fun withdraw(amount: Double, currency: Currency) =
        withdraw(BigDecimal.valueOf(amount), currency)
     ...
     * @return The result of the transaction
     */
    suspend fun transfer(amount: Double, currency: Currency, receiver: TransactionUser) =
        transfer(BigDecimal.valueOf(amount), currency, receiver)
