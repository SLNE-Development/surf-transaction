...
interface TransactionService {
     ...
     */
    suspend fun transfer(senderTransaction: Transaction, receiverTransaction: Transaction): TransactionResult
    ...
    companion object {
        val INSTANCE: TransactionService = Services.serviceWithFallback(TransactionService::class.java).orElseThrow {
