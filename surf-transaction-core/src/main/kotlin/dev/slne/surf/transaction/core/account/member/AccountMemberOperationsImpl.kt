package dev.slne.surf.transaction.core.account.member
...
class AccountMemberOperationsImpl(
    ...
    override suspend fun addMember(
        ...
        val result = AccountServiceImpl.get().addMemberToAccount(accountId, executor, target)
    ...
    override suspend fun removeMember(
        ...
        val result = AccountServiceImpl.get().removeMemberFromAccount(accountId, executor, target)
        if (result == AccountMemberResult.SUCCESS) {
