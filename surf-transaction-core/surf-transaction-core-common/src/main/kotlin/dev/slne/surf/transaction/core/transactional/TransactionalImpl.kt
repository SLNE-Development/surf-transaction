...
class TransactionalImpl : Transactional {
    ...
    override suspend fun deposit(
        ...
        return CoreTransactionService.get().deposit(
            account,
            initiator,
            amount,
            currency,
    ...
    override suspend fun withdraw(
        ...
        return CoreTransactionService.get().withdraw(
            account,
            initiator,
            amount,
            currency,
    ...
    override suspend fun transfer(
        ...
        return CoreTransactionService.get().transfer(
            initiator,
            sender,
            amount,
            currency,
    ...
    override suspend fun balance(
        ...
        return CoreTransactionService.get().balance(account, currency)
    }
}
