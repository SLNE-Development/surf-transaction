...
class AccountMemberOperationsImpl(
    ...
    override suspend fun addMember(
        ...
        val result = CoreAccountService.get().addMemberToAccount(accountId, executor, target)
    ...
    override suspend fun removeMember(
        ...
        val result = CoreAccountService.get().removeMemberFromAccount(accountId, executor, target)
        if (result == AccountMemberResult.SUCCESS) {
