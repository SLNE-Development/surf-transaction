...
@Serializable
class AddMemberToAccountRequest(
    val accountId: SerializableStringUUID,
    val executor: SerializableStringUUID,
    val target: SerializableStringUUID
) : RabbitRequestPacket<AddMemberToAccountResponse>()

@Serializable
class AddMemberToAccountResponse(val result: AccountMemberResult) : RabbitResponsePacket()
